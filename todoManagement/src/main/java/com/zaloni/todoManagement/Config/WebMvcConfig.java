package com.zaloni.todoManagement.Config;
...
@Configuration
@EnableWebMvc
@ComponentScan("com.zaloni.todoManagement")
...
public class WebMvcConfig {
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        sessionFactory.setPackagesToScan(new String[] { "com.zaloni.todoManagement" });
        sessionFactory.setHibernateProperties(hibernateProperties());
		  sessionFactory.setAnnotatedClasses(User.class);
		  sessionFactory.setAnnotatedClasses(Todos.class);
